package com.example.my_bilet_android_studio;
...
import com.example.my_bilet_android_studio.model.RailwayTicketChild;
...
public class MainActivity extends AppCompatActivity {
    ...
    RailwayTicket railwayTicketPensioner = new RailwayTicketChild(70, 5, 30);
    ...
    private TextView railwayTicketPensionerOut; // поле вывода общей стоимости билетов пенсионеров
    ...
    protected void onCreate(Bundle savedInstanceState) { // создание жизненного цикла активности
        ...
        railwayTicketPensionerOut = findViewById(R.id.railwayTicketPensionerOut); // вывод информации стоимости всех билетов пенсионеров
        ...
        //3) заполнение третьего поля воспользовавшись переопределённым методом подсчёта стоимости билетов пенсионеров ticketPriceAll()
        railwayTicketPensionerOut.setText(Float.toString(railwayTicketPensioner.ticketPriceAll()) + " монет");

        // 4) заполнение четверього поля стоимостью всех билетов
